...
#include "RockAbilityTagRelationshipMapping.generated.h"

class UObject;

/** Struct that defines the relationship between different ability tags */
USTRUCT()
struct FRockAbilityTagRelationship
{
	GENERATED_BODY()
...
UCLASS()
class ROCKMODULARGAMEPLAYABILITIES_API URockAbilityTagRelationshipMapping : public UDataAsset
{
	GENERATED_BODY()
...
private:
	...
	TArray<FRockAbilityTagRelationship> AbilityTagRelationships;
